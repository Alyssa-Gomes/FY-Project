% SFLA - Drop-Wave Benchmark Function
...
% Objective Function
problem.CostFunction = @(x) drop_wave(x);

problem.nVar = 2;              % Number of Unknown Variables

problem.VarMin = -5.12;           % Lower Bound of Unknown Variables
problem.VarMax = 5.12;           % Upper Bound of Unknown Variables
