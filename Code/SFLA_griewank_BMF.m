% SFLA - Griewank Benchmark Function
...
% Objective Function
problem.CostFunction = @(x) griewank(x);

problem.nVar = 2;              % Number of Unknown Variables

problem.VarMin = -600;           % Lower Bound of Unknown Variables
problem.VarMax = 600;           % Upper Bound of Unknown Variables
