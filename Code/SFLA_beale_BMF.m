...
% Objective Function
problem.CostFunction = @(x) beale(x);

problem.nVar = 2;              % Number of Unknown Variables

problem.VarMin = -4.5;           % Lower Bound of Unknown Variables
problem.VarMax = 4.5;           % Upper Bound of Unknown Variables
