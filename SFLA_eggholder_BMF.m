% SFLA - Eggholder Benchmark Function
...
% Objective Function
problem.CostFunction = @(x) eggholder(x);

problem.nVar = 2;              % Number of Unknown Variables

problem.VarMin = -512;           % Lower Bound of Unknown Variables
problem.VarMax = 512;           % Upper Bound of Unknown Variables
