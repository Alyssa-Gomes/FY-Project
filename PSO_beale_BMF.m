...
%% Problem Definition
problem.Function = @(x) beale(x);  % Cost Function
problem.nVar = 2;      % Number of Unknown Decision Variables
problem.VarMin = -4.5;   % Lower Bound of Decision Variables
problem.VarMax =  4.5;   % Upper Bound of Decision Variables
