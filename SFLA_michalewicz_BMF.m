% SFLA - Michalewicz Benchmark Function
...
% Objective Function
problem.CostFunction = @(x) michalewicz(x);

problem.nVar = 10;              % Number of Unknown Variables

problem.VarMin = 0;           % Lower Bound of Unknown Variables
problem.VarMax = pi;           % Upper Bound of Unknown Variables
