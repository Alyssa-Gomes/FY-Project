% PSO - Sum Squares Benchmark Function
...
%% Problem Definition
problem.Function = @(x) Sum_Square(x);  % Cost Function
problem.nVar = 30;      % Number of Unknown Decision Variables
problem.VarMin = -5.12;   % Lower Bound of Decision Variables
